...
(function() {
      ...
      if (selectTyped) {
        ...
        if (typed_strings) {
          try {
            ...
            console.log('Typed.js initialization delayed');
  ...
  // Initialize Typed with delay to avoid React hydration conflicts
  setTimeout(() => {
  ...
  // Initialize PureCounter with delay to avoid React hydration conflicts
  ...
  function initGLightbox() {
    if (typeof GLightbox !== 'undefined') {
      try {
        ...
        console.log('GLightbox initialization delayed');
  ...
  // Initialize GLightbox with delay to avoid React hydration conflicts
  setTimeout(() => {
    if (document.readyState === 'loading') {
